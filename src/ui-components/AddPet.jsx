...
export default function AddPet(props) {
  ...
  const [
    textFieldFourEightFiveOneOneTwoZeroOneValue,
    setTextFieldFourEightFiveOneOneTwoZeroOneValue,
  ] = useStateMutationAction("");
  const [
    textFieldFourEightFiveOneOneTwoOneFiveValue,
    setTextFieldFourEightFiveOneOneTwoOneFiveValue,
  ] = useStateMutationAction("");
  const [
    textFieldFourEightFiveOneOneTwoZeroEightValue,
    setTextFieldFourEightFiveOneOneTwoZeroEightValue,
  ] = useStateMutationAction("");
  const buttonTwoNineSevenSixSixNineTwoSixOnClick = useDataStoreCreateAction({
    fields: {
      ...
      about: textFieldFourEightFiveOneOneTwoZeroOneValue,
      image: textFieldFourEightFiveOneOneTwoOneFiveValue,
      color: textFieldFourEightFiveOneOneTwoZeroEightValue,
    },
    model: Pet,
    schema: schema,
  });
  const buttonFourEightFiveOneOneTwoThreeEightOnClick =
    useDataStoreUpdateAction({
      fields: {
        name: textFieldTwoNineSevenSixSixNineTwoTwoValue,
        age: textFieldTwoNineSevenSixSixNineTwoThreeValue,
      ...
      >
        ...
        >
          <Image
            ...
            padding="0px 0px 0px 0px"
            objectFit="cover"
            src="https://cdn.pixabay.com/photo/2021/01/29/08/08/dog-5960092_640.jpg"
        ...
        >
          ...
          <TextField
            ...
            labelHidden={false}
            variation="default"
            value={textFieldFourEightFiveOneOneTwoZeroOneValue}
            onChange={(event) => {
              setTextFieldFourEightFiveOneOneTwoZeroOneValue(
                event.target.value
              );
            }}
            {...getOverrideProps(overrides, "TextField48511201")}
          ></TextField>
          <TextField
            width="unset"
            height="unset"
            ...
            labelHidden={false}
            variation="default"
            value={textFieldFourEightFiveOneOneTwoZeroEightValue}
            onChange={(event) => {
              setTextFieldFourEightFiveOneOneTwoZeroEightValue(
                event.target.value
              );
            }}
            {...getOverrideProps(overrides, "TextField48511208")}
          ></TextField>
          <TextField
            width="unset"
            height="unset"
            ...
            labelHidden={false}
            variation="default"
            value={textFieldFourEightFiveOneOneTwoOneFiveValue}
            onChange={(event) => {
              setTextFieldFourEightFiveOneOneTwoOneFiveValue(
                event.target.value
              );
            }}
            {...getOverrideProps(overrides, "TextField48511215")}
          ></TextField>
        </Flex>
        <Flex
          gap="40px"
        ...
        >
          ...
          <Button
            ...
            children="Update"
            onClick={() => {
              buttonFourEightFiveOneOneTwoThreeEightOnClick();
            }}
            {...getOverrideProps(overrides, "Button48511238")}
          ></Button>
        </Flex>
      </Flex>
    </Flex>
