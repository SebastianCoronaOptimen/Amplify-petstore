...
export default function PetProfile(props) {
  ...
  const buttonFourEightFourEightFiveZeroTwoOnClick = useDataStoreDeleteAction({
    id: pet?.id,
    model: Pet,
    schema: schema,
  });
  return (
    <Flex
      ...
      backgroundColor="rgba(149,204,255,1)"
    ...
    >
      <Button
        ...
        children="Delete"
        onClick={() => {
          buttonFourEightFourEightFiveZeroTwoOnClick();
        }}
        {...getOverrideProps(overrides, "Button4848502")}
      ></Button>
      <Image
        width="160px"
        height="160px"
      ...
      <Button
        ...
        variation="primary"
        children="Update"
        {...getOverrideProps(overrides, "Button4848427")}
      ></Button>
    </Flex>
  );
}
